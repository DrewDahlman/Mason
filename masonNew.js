			...
			function sizeElements() {
				...
				if (col == 1) {
					...
					*/
					...
					var h = parseFloat(elements.block.height) - (settings.mobileGutter * 2);
					var w = parseFloat(elements.block.width) - (settings.mobileGutter * 2);
					$sel.height(h + 'px');
					$sel.width(w + 'px');
					
					$sel.css({
						'margin': (settings.mobileGutter), 
					});
				} else {
